function Features() {
    ...
    const features = [
        { color: 'sky', title: 'Usage Tracking', content: "Automatically monitor daily headphone and earphone usage across supported streaming activity." },
        { color: 'emerald', title: 'Visual Analytics', content: "Understand your listening behavior through clean charts, timelines, and interactive insights." },
        { color: 'rose', title: 'AI Powered Insights', content: "Receive intelligent summaries and pattern detection to improve long - term listening habits." },
        { color: 'purple', title: 'Health Focused Monitoring', content: "Identify overuse trends and maintain healthier audio consumption with informed decisions." },
        // { color: 'amber', title: 'Secure & Private by Design', content: "Your usage data is encrypted, controlled by you, and never shared without permission." },
    ]
