        ...
        <>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-3/5 flex flex-col gap-8 w-3/4 md:w-1/3 h-auto bg-stone-300 dark:bg-stone-700 rounded-md p-4 z-100">
                ...
                <div className="flex flex-col items-center gap-4 ">
                    ...
                    <form className="flex flex-col justify-around gap-4 w-full" onSubmit={() => { }}>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input type="text" name="note" id="note" inputMode="numeric" pattern="[0-9]*" className="px-2 py-1 border-2 border-slate-200 outline-slate-200 rounded-sm text-slate-800 dark:text-slate-200" placeholder="ex. Listening Eminem" />
                        </div>
