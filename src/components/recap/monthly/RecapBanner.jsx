...
const useMonthlyRecapWindow = () => {
    ...
    const recapMonth = month === 0 ? 12 : month   // 1-indexed prev month
...
const RecapBanner = () => {
    ...
    const window = useMonthlyRecapWindow()

    if (!window) return null

    const { recapMonth, recapYear } = window
    const monthName = MONTH_NAMES[recapMonth - 1]
    const go = () => navigate(`/recap/${recapYear}/${recapMonth}`)
        ...
        <AnimatePresence>
            ...
            >
                ...
                >
                    ...
                    />
                    <motion.div className="absolute -right-8 -top-8 w-36 h-36 rounded-full bg-purple-500/5 pointer-events-none"
                    ...
                    <div className="relative flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            <div className="relative flex-shrink-0">
                                <motion.div className="absolute inset-0 rounded-xl bg-purple-400/20"
                            ...
                            <div className="flex flex-col gap-0.5">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-purple-400 text-[10px] font-bold uppercase tracking-[0.2em] font-poppins">New</span>
                                </div>
